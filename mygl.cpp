...
bool mygl::operator !=(const MyGL_StencilOp &lhs, const MyGL_StencilOp &rhs) {
  return lhs.stencilFail != rhs.stencilFail || lhs.stencilPassDepthFail != rhs.stencilPassDepthFail || lhs.stencilPassDepthPass != rhs.stencilPassDepthPass;
}

bool mygl::operator !=(const MyGL_Stencil &lhs, const MyGL_Stencil &rhs) {
  return lhs.on != rhs.on ||
// lhs.separate != rhs.separate ||
      lhs.writeMask != rhs.writeMask || lhs.stencilTest != rhs.stencilTest || lhs.stencilOp != rhs.stencilOp;  // ||
...
void mygl::Uniform::set(const int32_t &v) {
  glUniform1i(loc, v);
}
void mygl::Uniform::set(const MyGL_IVec2 &v) {
  glUniform2iv(loc, 1, v.i2);
}
void mygl::Uniform::set(const MyGL_IVec3 &v) {
  glUniform3iv(loc, 1, v.i3);
}
void mygl::Uniform::set(const MyGL_IVec4 &v) {
  glUniform4iv(loc, 1, v.i4);
}

void mygl::Uniform::set(const uint32_t &v) {
  glUniform1ui(loc, v);
}
void mygl::Uniform::set(const MyGL_UVec2 &v) {
  glUniform2uiv(loc, 1, v.u2);
}
void mygl::Uniform::set(const MyGL_UVec3 &v) {
  glUniform3uiv(loc, 1, v.u3);
}
void mygl::Uniform::set(const MyGL_UVec4 &v) {
  glUniform4uiv(loc, 1, v.u4);
}

void mygl::Uniform::set(const float &v) {
  glUniform1f(loc, v);
}
void mygl::Uniform::set(const MyGL_Vec2 &v) {
  glUniform2fv(loc, 1, v.f2);
}
void mygl::Uniform::set(const MyGL_Vec3 &v) {
  glUniform3fv(loc, 1, v.f3);
}
void mygl::Uniform::set(const MyGL_Vec4 &v) {
  glUniform4fv(loc, 1, v.f4);
}

void mygl::Uniform::set(const MyGL_Mat2 &v) {
  glUniformMatrix2fv(loc, 1, GL_TRUE, v.f4);
}
void mygl::Uniform::set(const MyGL_Mat3 &v) {
  glUniformMatrix3fv(loc, 1, GL_TRUE, v.f9);
}
void mygl::Uniform::set(const MyGL_Mat4 &v) {
  glUniformMatrix4fv(loc, 1, GL_TRUE, v.f16);
}
